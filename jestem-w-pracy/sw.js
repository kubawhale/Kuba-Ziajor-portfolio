...
const CACHE = "under-v7";
const FILES = ["./", "index.html", "manifest.webmanifest", "icons/apple-touch-icon.png", "icons/icon-192.png", "icons/icon-512.png", "icons/icon-light-192.png", "fonts/baron-neue-900-normal.woff2"];
